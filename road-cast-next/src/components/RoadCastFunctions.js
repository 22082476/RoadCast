const DrizzleIcon = '/icons/drizzle.svg';
const RainIcon = '/icons/rain.svg';
const SnowIcon = '/icons/snow.svg';
const SleetIcon = '/icons/sleet.svg';
const OvercastIcon = '/icons/overcast.svg';
const SunriseIcon = '/icons/sunrise.svg';
const SunsetIcon = '/icons/sunset.svg';
const FogIcon = '/icons/fog.svg';
const MistIcon = '/icons/mist.svg';
const HazeIcon = '/icons/haze.svg';
const CloudyIcon = '/icons/cloudy.svg';
const ClearIcon = '/icons/clear-day.svg';
